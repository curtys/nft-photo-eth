...
module.exports = {
  ...
  externalnode: {
    enabled: true,
    endpoint: "localhost:8545", // Endpoint of an node to connect to. Can be on localhost or on the internet
    accounts: [
      {
        mnemonic: "castle deposit fatigue ugly wood because luxury assault book tray picture tenant",
        hdpath: "m/44'/60'/0'/0/",
        numAddresses: "10"
      }
    ]
